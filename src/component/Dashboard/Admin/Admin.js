...
const SideNav = lazy(() =>
  import("component/Dashboard/Common/SideNav/SideNav")
);
const Dashboard = lazy(() =>
  import("component/Dashboard/Admin/Dashboard/Dashboard")
);
const InterviewerList = lazy(() =>
  import("component/Dashboard/Interviewer/List/InterviewerList")
);
const StudentList = lazy(() =>
  import("component/Dashboard/Student/List/StudentList")
);
const TopicsList = lazy(() =>
  import("component/Dashboard/Common/Topics/List/TopicsList")
);
const ResourceList = lazy(() =>
  import("component/Dashboard/Common/Resource/ResouceList")
);
const QuizList = lazy(() => import("component/Dashboard/Common/Quiz/Quiz"));

const QuizContent = lazy(() =>
  import("component/Dashboard/Common/Quiz/QuizContent/QuizContent")
);

const QueryList = lazy(() =>
  import("component/Dashboard/Common/Queries/Queries")
);
