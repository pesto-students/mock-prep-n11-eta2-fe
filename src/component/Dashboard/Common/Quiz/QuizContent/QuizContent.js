                           ...
                           <section className="slide">
                               ...
                               <p>Question {index+1} of {quiz.length} </p>
                                   <h1 className="question">{quiz[index].question} ?</h1> 
                                       ...
                                       <QuizOptionForm attempt={attempt} attempted={attempted} setQuiz={setQuiz} index={index} quiz={quiz} options={quiz[index].options}  multiple={quiz[index].multipleChoice} />
                                       </section>
                        ...
                        <section className="slides">
                            ...
                            <section className="navigation">
                                ...
                                <h3>Completed<br />  <p>{quizDetail.description}</p></h3>
                                    ...
                                    <button className="btn btn-success" onClick={handleComplete}>Submit Quiz</button>
                                </div>                                    
                            </section>
                        </section>}
            </> :
