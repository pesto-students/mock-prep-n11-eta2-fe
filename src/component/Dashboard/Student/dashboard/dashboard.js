...
const DashboardCards = lazy(() =>
  import("component/Dashboard/Student/dashboard/Cards/DashboardCards")
);
const Interviews = lazy(() =>
  import("component/Dashboard/Student/dashboard/Upcoming Interviews/Interviews")
);
const TopicsStudying = lazy(() =>
  import("component/Dashboard/Student/dashboard/TopicsStudying/Topics")
);
...
export default function InterviewerDashboard() {
  ...
  useEffect(() => {
    ...
    if (data && data.studentList) {
      setStudents(data.studentList.data);
    }
  }, [data]);
