...
export const StudentProfile = () => {
    ...
    const data = <Forms populate="true" submitFunction={submit} formFields={studentForm} textArea={interviewer.about} buttonValue="Update Details" /> 
    ...
    return (
        <>
            <div className="interviewer-profile">
                <DashboardHeader title="Student Profile" icon={UserIcon} rightComponent={auth.user.role !== "interviewer" ?<> {update ? component1: component2} </>: <></>} />
                    ...
                    <>{interviewer && Object.keys(interviewer).length>0 ?
                        ...
                        <div className="int-profile-container">
                            <section className="left-profile">
                                ...
                                <p>{interviewer.degree}, {interviewer.company}</p>
