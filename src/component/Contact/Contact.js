      ...
      {!loading ? (
        <section id="contactForm">
          <section id="info">
            <h3>Send Query</h3>
            <p>
              Fill the requested details and our team will respond within
              24hours.
            </p>
            <a href="/contact" className="link">
              <p>{phoneIcon} 8553548534</p>
            </a>
            <br />
            <a
              ...
              className="link"
            >
              <p>{emailIcon} info@mockprep.com</p>
            </a>
            <br />
            <a href="/contact" className="link">
              <p>{mapIcon} #123, Infinity Park, Bangalore</p>
            </a>
          </section>
          <section id="query">
