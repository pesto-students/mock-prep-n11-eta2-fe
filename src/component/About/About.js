      ...
      <section className="aboutContainer">
        ...
        <Suspense fallback={<div>Loading</div>}>
          <section id="aboutContent">
            <h2>
              We are <span id="title">Mock Prep</span>
            </h2>
            <p className="about">
              Providing solutions to interview preparation
            </p>
            <p className="about">
              At Mock prep, we want to help students prepare of technical
            ...
            <p className="about">
              ...
              an interview process and allowing our users to engage with
              experienced individuals in their field to be guided in the right
              way to overcome any gaps in their preparation.
            </p>
            <Link to="/join">
              <button className="btn btn-transparent border-secondary hover">
                Join as Instructor
              </button>
            </Link>
          </section>
