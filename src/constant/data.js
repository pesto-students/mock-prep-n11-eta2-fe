...
export const packages = [
  ...
  },
  {
    ...
    details: [
      "Top Interviewer",
      "30 mins Consulting Session",
      "Guidance & Query Solving",
      "Session recording for self-analysis",
      "Money-back Guarantee",
    ],
  },
];
...
export const CustomerReviews = [
  {
    ...
    rating: 5,
    profile:
      "https://res.cloudinary.com/mock-prep/image/upload/v1638311080/Mockprep/Students/67_mzwjc0.jpg",
  },
  {
    id: 2,
    name: "Saif",
...
export const tableColumns = [
  ...
  },
  {
    ...
    rowKey: 3,
    render: (st, index) => {
      return <section key={index}>{st.name}</section>;
    },
  },
  {
    title: "Student",
    ...
    rowKey: 4,
    render: (int, index) => {
      return <section key={index}>{int.name}</section>;
    },
  },
  {
    title: "Date (MM/DD/YY)",
